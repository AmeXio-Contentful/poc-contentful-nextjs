...
module.exports = withPlugins(plugins, {
  ...
  env: {
    ...
    CONTENTFUL_ACCESS_TOKEN_LOCAL: process.env.CONTENTFUL_ACCESS_TOKEN_LOCAL,
    CONTENTFUL_PREVIEW_ACCESS_TOKEN_LOCAL: process.env.CONTENTFUL_PREVIEW_ACCESS_TOKEN_LOCAL,
  },
