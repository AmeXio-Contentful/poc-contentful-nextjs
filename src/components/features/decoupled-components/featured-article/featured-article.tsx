...
export default function FeaturedArticle({
  ...
  return (
    <div className="relative bg-[#D9E8F5] text-[#084772] py-14 px-9 flex flex-col gap-y-6 items-start h-full text-left">
      <div className="w-3/5">
        <h4
          className="flex flex-row font-bold items-center gap-x-4"
